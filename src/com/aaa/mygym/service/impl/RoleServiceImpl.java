...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public Map<String, Object> getAllRoleInfo(Integer pageNumber, Integer pageSize, String searchName,String id) throws Exception {
        //参数校验
        if (pageNumber == 0) {
        ...
        List<Role> roleList = roleDao.getAllRoleInfo(pageNumber, pageSize, searchName,id);
        int count = roleDao.getAllRoleInfoCount(searchName, id);
