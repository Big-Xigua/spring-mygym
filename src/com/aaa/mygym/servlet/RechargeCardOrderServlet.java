 ...
 * 获取会员刷卡页面中的会员充值记录
**/ 
@WebServlet(name = "RechargeCardOrderServlet",urlPatterns = "/RechargeCardOrderServlet")
public class RechargeCardOrderServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            cardService.getAllRechargeRecord(pageNumber, pageSize, searchId, searchName);
            responseDto.setData(cardService.getAllRechargeRecord(pageNumber, pageSize, searchId, searchName));
