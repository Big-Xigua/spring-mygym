var initmenu_url = "/GetMenuListByRoleIdServlet";
...
$(function(){
     ...
     * 给topUserName 赋值
     */
    $("#topUserName").html(localStorage.getItem("userName"));
    accordion();
...
function lookNoticMessage() {
    addMenum('systemNoticeMessage','message/views/noticeMessage.html','公告管理');
